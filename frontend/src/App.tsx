      ...
      <main className="max-w-6xl mx-auto px-6 py-10 relative z-10">
        <div className="mb-10">
          ...
          <div className="flex gap-2 mt-4 flex-wrap items-center">
            ...
            <button onClick={() => { setInput("Le gouvernement a annoncé fin mai 2026 une réforme du système d'assurance chômage, réduisant la durée maximale d'indemnisation de 18 à 12 mois. Le Premier ministre a justifié cette mesure par un taux de chômage à 7,1% et un déficit public à 5,2% du PIB. Les syndicats CGT et CFDT ont immédiatement appelé à une journée de mobilisation le 10 juin. Laurent Berger, ex-leader de la CFDT, a qualifié la réforme de 'recul social majeur'. L'opposition de gauche dépose une motion de censure. Le patronat (MEDEF) salue 'un signal fort pour la compétitivité'. Les associations de chômeurs alertent sur 800 000 personnes qui perdraient leurs droits."); setProfile('bfm') }} className="text-[11px] px-3 py-1.5 rounded-full border border-red-500/20 bg-red-500/5 text-red-400/80 hover:bg-red-500/15 hover:text-red-300 transition-all">🏛️ Réforme — BFM</button>
            <button onClick={() => { setInput("Sensation à Roland-Garros 2026 : le Français Giovanni Mpetshi Perricard, 21 ans et 45e mondial, a éliminé Carlos Alcaraz en huitièmes de finale en cinq sets (4-6, 7-6, 3-6, 6-4, 7-5) sur le court Philippe-Chatrier. Le géant d'1m98 a servi 42 aces, dont 3 dans le tie-break décisif. C'est la plus grosse surprise du tournoi depuis la défaite de Nadal contre Söderling en 2009. Le public du Chatrier, acquis à sa cause, a porté le jeune Français pendant 3h47 de jeu. En conférence de presse, Mpetshi Perricard a déclaré : 'J'ai joué le match de ma vie, je n'ai rien à perdre.' Il affrontera Jannik Sinner en quarts de finale."); setProfile('lequipe') }} className="text-[11px] px-3 py-1.5 rounded-full border border-yellow-500/20 bg-yellow-500/5 text-yellow-400/80 hover:bg-yellow-500/15 hover:text-yellow-300 transition-all">🎾 Roland-Garros — L'Équipe</button>
            <button onClick={() => { setInput("Le phénomène 'No Phone Challenge' explose sur TikTok fin mai 2026. Le principe : des jeunes de 16-25 ans se filment en rendant leur smartphone pendant 7 jours et documentent leur quotidien sans écran. Le hashtag #NoPhoneChallenge cumule 2,3 milliards de vues en deux semaines. Des lycéens organisent des 'semaines déconnectées' dans leurs établissements. Les psychologues saluent l'initiative mais alertent sur le risque de 'binge numérique' au retour. Le ministre de l'Éducation nationale a réagi : 'Cette génération nous surprend, elle est capable de se remettre en question.' Les marques de télécom, elles, restent silencieuses."); setProfile('konbini') }} className="text-[11px] px-3 py-1.5 rounded-full border border-purple-500/20 bg-purple-500/5 text-purple-400/80 hover:bg-purple-500/15 hover:text-purple-300 transition-all">📱 No Phone — Konbini</button>
            <button onClick={() => { setInput("Mistral AI, la startup française d'intelligence artificielle, annonce une levée de fonds de 2 milliards d'euros en série C, la plus importante jamais réalisée en Europe dans le secteur de l'IA. La valorisation atteint désormais 12 milliards d'euros. Les investisseurs incluent General Atlantic, Lightspeed et BPI France. Le CEO Arthur Mensch prévoit le recrutement de 500 ingénieurs d'ici fin 2026 et l'ouverture de bureaux à Tokyo et São Paulo. L'entreprise revendique 15 000 clients entreprises et un chiffre d'affaires annualisé de 400 millions d'euros. Le fonds souverain saoudien PIF entre également au capital, suscitant un débat sur la souveraineté technologique européenne."); setProfile('linkedin') }} className="text-[11px] px-3 py-1.5 rounded-full border border-blue-500/20 bg-blue-500/5 text-blue-400/80 hover:bg-blue-500/15 hover:text-blue-300 transition-all">🤖 Mistral AI — LinkedIn</button>
