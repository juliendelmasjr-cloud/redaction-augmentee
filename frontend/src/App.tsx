      ...
      <main className="max-w-6xl mx-auto px-6 py-10 relative z-10">
        <div className="mb-10">
          ...
          <div className="flex gap-2 mt-4 flex-wrap items-center">
            ...
            <button onClick={() => { setInput("Dans la nuit du 23 au 24 mai 2026, la Russie a lancé une attaque massive de missiles et de drones sur l'Ukraine, ciblant principalement Kiev et sa région. Le bilan provisoire fait état d'au moins quatre morts et plus de 100 blessés selon les autorités ukrainiennes. L'armée de l'air ukrainienne rapporte l'usage d'un missile balistique Orechnik, une arme hypersonique récemment développée par Moscou. Plusieurs infrastructures civiles ont été touchées, dont un hôpital et des immeubles résidentiels. Le président Zelensky a appelé les alliés occidentaux à renforcer les systèmes de défense antiaérienne. Le Conseil de sécurité de l'ONU doit se réunir en session d'urgence."); setProfile('bfm') }} className="text-[11px] px-3 py-1.5 rounded-full border border-red-500/20 bg-red-500/5 text-red-400/80 hover:bg-red-500/15 hover:text-red-300 transition-all">🇺🇦 Ukraine — BFM</button>
            <button onClick={() => { setInput("Roland-Garros 2026 a débuté sous des chaleurs exceptionnelles, avec des températures dépassant 35°C sur les courts dès le premier jour. Plusieurs joueurs ont souffert de malaises, dont le Français Ugo Humbert qui a dû abandonner au deuxième set. L'organisation a activé le protocole chaleur extrême basé sur l'indice WBGT (Wet Bulb Globe Temperature), autorisant des pauses de 10 minutes entre le 3e et le 4e set. Le court Philippe-Chatrier, équipé de son toit rétractable, a été fermé dès 14h pour protéger les joueurs. La directrice du tournoi Amélie Mauresmo a déclaré : 'La santé des athlètes est notre priorité absolue.'"); setProfile('lequipe') }} className="text-[11px] px-3 py-1.5 rounded-full border border-yellow-500/20 bg-yellow-500/5 text-yellow-400/80 hover:bg-yellow-500/15 hover:text-yellow-300 transition-all">🎾 Roland-Garros — L'Équipe</button>
            <button onClick={() => { setInput("La France a connu fin mai 2026 une vague de chaleur précoce inédite, avec des records de température battus dans 15 départements. À Paris, le thermomètre a atteint 38,2°C le 28 mai, du jamais vu à cette période. Les écoles de plusieurs académies ont activé le plan canicule, avec des horaires aménagés et des cours annulés l'après-midi. La RATP a distribué 50 000 bouteilles d'eau dans le métro parisien. Sur les réseaux sociaux, les vidéos de fontaines prises d'assaut et de terrasses désertées à l'heure du déjeuner sont devenues virales. Météo-France prévient : 'Ce type d'épisode va devenir la norme d'ici 2030.'"); setProfile('konbini') }} className="text-[11px] px-3 py-1.5 rounded-full border border-purple-500/20 bg-purple-500/5 text-purple-400/80 hover:bg-purple-500/15 hover:text-purple-300 transition-all">🌡️ Canicule — Konbini</button>
            <button onClick={() => { setInput("Emmanuel Macron a présenté le 27 mai 2026 un plan d'accélération de l'électrification de la France, doté de 8 milliards d'euros sur 5 ans. Les mesures phares incluent l'installation de 200 000 nouvelles bornes de recharge d'ici 2028, une prime renforcée de 7 000 euros pour l'achat d'un véhicule électrique fabriqué en Europe, et un objectif de 2 millions de pompes à chaleur installées par an. Le président a déclaré depuis l'usine Renault de Douai : 'La France doit devenir le leader européen de la mobilité électrique.' Le patronat (MEDEF) salue le plan tandis que les ONG environnementales le jugent 'insuffisant face à l'urgence climatique.'"); setProfile('linkedin') }} className="text-[11px] px-3 py-1.5 rounded-full border border-blue-500/20 bg-blue-500/5 text-blue-400/80 hover:bg-blue-500/15 hover:text-blue-300 transition-all">⚡ Électrification — LinkedIn</button>
            <button onClick={() => { setInput("La startup NovaPower, basée à Shenzhen, affirme avoir mis au point une batterie révolutionnaire capable de se recharger intégralement en 10 secondes et de durer 50 ans sans dégradation. Selon son fondateur, le Dr. Wei Zhang, la technologie repose sur un nouveau matériau à base de graphène quantique. L'entreprise annonce un investissement de 500 millions de dollars et un partenariat avec Tesla. Aucune étude indépendante n'a validé ces résultats. La communauté scientifique exprime un scepticisme marqué, rappelant que les lois de la thermodynamique imposent des limites physiques strictes à la charge rapide des batteries."); setProfile('bfm') }} className="text-[11px] px-3 py-1.5 rounded-full border border-amber-500/20 bg-amber-500/5 text-amber-400/80 hover:bg-amber-500/15 hover:text-amber-300 transition-all">⚠️ Faux — Batterie</button>
          </div>
        </div>
